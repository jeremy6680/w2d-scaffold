...
| #   | Task                                           | Priority | Notes                                                 |
| --- | ---------------------------------------------- | -------- | ----------------------------------------------------- |
| 1   | Phase 3 — Template `wordpress-plugin`          | Medium   | plugin.php, includes/, templates/, assets/            |
| 2   | Phase 3 — Template `wordpress-theme`           | Medium   | functions.php, Twig templates, SCSS, acf-json/        |
| 3   | Phase 4 — Template `python`                    | Medium   | src/ layout, pyproject.toml, tests/                   |
| 4   | Phase 4 — Template `astro`                     | Medium   | Astro v5 + Tailwind v4 + SolidJS + Giscus + astro-seo |
| 5   | Phase 5 — README.md final + démo gif/asciinema | Low      |                                                       |
| 6   | Phase 5 — GitHub Actions (ruff + pytest)       | Low      | .github/workflows/ci.yml                              |
